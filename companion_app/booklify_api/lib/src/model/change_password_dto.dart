...
/// * [newPassword]
@BuiltValue()
abstract class ChangePasswordDto
    implements Built<ChangePasswordDto, ChangePasswordDtoBuilder> {
  ...
  factory ChangePasswordDto([void updates(ChangePasswordDtoBuilder b)]) =
      _$ChangePasswordDto;
  ...
  static Serializer<ChangePasswordDto> get serializer =>
      _$ChangePasswordDtoSerializer();
}

class _$ChangePasswordDtoSerializer
    implements PrimitiveSerializer<ChangePasswordDto> {
  @override
