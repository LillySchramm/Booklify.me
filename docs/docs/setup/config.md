...
## geonode
**Type:** `object`\
**Description:** [GeoNode](https://geonode.com/) is a paid service which provides services usefull for crawling. Read more about why you should use GeoNode for Booklify [here](/docs/crawlers/amazon).
### geonode.password
**Type:** `string`\
