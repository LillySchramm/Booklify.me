...
## brightdata
**Type:** `object`\
**Description:** BrightData is a proxy service which can be used to scrape websites. It is required for the Amazon crawler.
### brightdata.key
**Type:** `string`\
**Description:** The API key which is used to authenticate against the BrightData proxy.\
**Examples:**
- `"ey.."`

### brightdata.zone
**Type:** `string`\
**Description:** The zone which should be used by the BrightData proxy.\
**Examples:**
- `"web_unlocker1"`
...
## isbndb
**Type:** `object`\
**Description:** [ISBNdb](https://isbndb.com/) is a paid service which provides an API which is usefull for getting book metadata. Read more about why you should use ISBNdb for Booklify [here](/docs/crawlers/isbndb).
### isbndb.key
**Type:** `string`\
