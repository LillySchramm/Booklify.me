...
All stable versions are tagged with the version number. For example, to use version `v1.2.3`, you can use the following docker tags:
- `docker pull registry.cdev.nexus/booklify-ce/backend:v1.2.3`
- `docker pull registry.cdev.nexus/booklify-ce/frontend:v1.2.3`
